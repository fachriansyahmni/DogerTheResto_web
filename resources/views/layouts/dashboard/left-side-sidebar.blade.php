...
<div class="left-side-bar">
    <div class="brand-logo">
        <a href="index.html">
            <img src="{{ asset('/vendor/deskapp/vendors/images/deskapp-logo.png') }}" alt="" class="dark-logo">
            <img src="{{ asset('/vendor/deskapp/vendors/images/deskapp-logo-white.png') }}" alt="" class="light-logo">
        </a>
